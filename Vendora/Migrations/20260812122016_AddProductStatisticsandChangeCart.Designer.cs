...
namespace Vendora.Migrations
{
    ...
    [Migration("20260812122016_AddProductStatisticsandChangeCart")]
    partial class AddProductStatisticsandChangeCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ProductStatisticsForStores.ProductStatistics", b =>
                {
                    b.Property<string>("ProductId")
                        .HasMaxLength(26)
                        .HasColumnType("character(26)")
            ...
            modelBuilder.Entity("Domain.ProductStatisticsForStores.ProductStatistics", b =>
                {
                    b.HasOne("Domain.Products.Product", "Product")
                        .WithOne("Statistics")
                        .HasForeignKey("Domain.ProductStatisticsForStores.ProductStatistics", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
